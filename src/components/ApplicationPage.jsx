  ...
  const questions = [
    {
      ...
      question: "個人簡介和申請動機",
      answer: "身為一位全端工程師，我對深度學習和人工智慧領域有濃厚興趣。在優派國際和若水國際的工作經驗讓我接觸到許多 AI 相關應用，這激發了我想要深入學習的動機。由於本科系畢業，在學時有學習過線性代數，我期待能透過這個課程，建立紮實的理論基礎，特別是在線性代數和神經網路方面的知識，以便未來能開發更有深度的 AI 應用。"
    },
    {
      id: 2,
      icon: <Terminal className="w-6 h-6" />,
      question: "曾經做過哪些軟體工程技術相關的學習？若有作品請分享給我們。",
      answer: "由於我是本科系畢業，從大學時期選修課開始就不間斷學習新技術，從 IOS App，Android App，前後端網站開發，OpenGL，虛擬技術，研究所在圖學實驗室因應大數據的潮流進行視覺化的研究，使用了 react class component 以及 D3 JS 以及 Django 實作大型論壇 KOL 視覺化系統，同時也進行另一項與 AI 相關的研究，使用 YOLO 進行車流辨識，研究所期間也帶領學弟妹進行多項產學計畫累積經驗，開始工作後也開始學習沒學習過的 Vue，同時也學習後端微服務並且學習 Terraform 部署雲端，目前也因為專案撰寫 Electron 視窗程式並把經驗寫成鐵人賽文章，接下來持續關注Prompt Engineering，一路走來都是持續不斷學習新技術"
    },
    {
      id: 3,
      icon: <Clock className="w-6 h-6" />,
      question: "如果參與這個訓練，會怎麼安排學習時間？",
      answer: "平日的晚上每天可以投入至少三小時時間，假日可以每天投入至少六小時，總計可以提供三十小時左右的時間，目前有跟夥伴進行讀書會複習線性代數，往後也會依照學習地圖進行學習"
    },
    {
      id: 4,
      icon: <Code className="w-6 h-6" />,
      question: "軟體技術日新月異，如何確定選擇投入的領域是正確有回報的？",
      answer: "由於網頁開發的變化相對於其他軟體領域變化的十分快速，隨時關注目前趨勢是十分重要的，因此我會定期參加各大研討會以及活動，並持續關注各大技術社群以及開源專案來了解目前趨勢，並讓自己保持競爭力，另一個角度是我認為學習基礎是一定會有回報的，以報名此課程為例，學習 AI 基礎，包含課程中的線性代數以及神經網路等等，可以確保在 AI 領域一定會有回報"
    },
    {
      id: 5,
      icon: <Heart className="w-6 h-6" />,
      question: "請描述一件產生明顯負面情緒的經歷，如何處理該情緒？",
      answer: "在工作上我時常會將情緒與事實分開，專注於事實以及把事情完成往往可以降低情緒的影響，但難免還是會遇到不可抗力的情境，曾經有遇過在有時程壓力下臨近結案的一個月前突然被調整 scope，由於我是專案負責人，當時在會議上因為焦急而產生的負面情緒也跟著事實一同在會議上發酵，後來理解當時的作法並不是較好的處理方式，因此現在都會先理解狀況後接受並吸收當下的情緒才做之後的行動"
    },
    {
      id: 6,
